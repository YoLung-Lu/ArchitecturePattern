...
class ArticleRXAdapter(context: Context, private val articleData: MutableList<Article>):
    RecyclerView.Adapter<ArticleRXAdapter.ViewHolder>() {

    // State.
    private var showDetail = true

    private val mInflater: LayoutInflater = LayoutInflater.from(context)
    private lateinit var clickedArticle: PublishSubject<Article>
    ...
    inner class ViewHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        override fun onClick(view: View) {
            clickedArticle.onNext(articleData[adapterPosition])
        }
